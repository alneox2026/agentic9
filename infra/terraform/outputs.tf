...
output "billing_api_5xx_alert_policy_name" {
  value       = google_monitoring_alert_policy.billing_api_5xx.name
  description = "Cloud Monitoring alert policy for Billing API 5xx responses."
}
