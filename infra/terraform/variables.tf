...
variable "billing_reconciler_service_account_name" {
  ...
  type        = string
  default     = "agentic9-reconciler-sa"
}
...
variable "pubsub_topic_name" {
  ...
  type        = string
  default     = "agent-turn-events-agentic9"
}
...
variable "firestore_idempotency_collection" {
  ...
  type        = string
  default     = "processed_events_agentic9"
}
...
variable "firestore_billing_ledger_collection" {
  ...
  type        = string
  default     = "agent_billing_ledger_agentic9"
}
...
variable "firestore_customer_wallets_collection" {
  ...
  type        = string
  default     = "customer_wallets_agentic9"
}
...
variable "firestore_billing_reservations_collection" {
  ...
  type        = string
  default     = "billing_reservations_agentic9"
}
...
variable "firestore_wallet_transactions_collection" {
  ...
  type        = string
  default     = "wallet_transactions_agentic9"
}
...
variable "firestore_customer_billing_periods_collection" {
  ...
  type        = string
  default     = "customer_billing_periods_agentic9"
}
...
variable "firestore_customer_billing_accounts_collection" {
  ...
  type        = string
  default     = "customer_billing_accounts_agentic9"
}
...
variable "firestore_stripe_webhook_events_collection" {
  ...
  type        = string
  default     = "stripe_webhook_events_agentic9"
}
...
variable "billing_api_stripe_webhook_signing_secret_id" {
  ...
  type        = string
  default     = "stripe-webhook-signing-secret-agentic9"
}
...
variable "firestore_subscription_cancellation_requests_collection" {
  ...
  type        = string
  default     = "subscription_cancellation_requests_agentic9"
}
